...
<header class="fixed top-0 flex items-center justify-between w-screen p-4" transition:slide>
  <Button variant="secondary" size="icon-lg" href="/">
    <ArrowLeft />
  </Button>
		...
		<div transition:slide class="flex flex-col items-center justify-center gap-4">
			...
			{#if streetName}
				<div transition:slide>
					<Badge class="text-blue-500 text-3xl" variant="secondary">
						{streetName}
					</Badge>
				</div>
			{/if}
